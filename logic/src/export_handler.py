...
import threading
from logic.workspace_logic import WorkspaceFrameLogic  # Import the necessary class

class ExportHandler:
    def __init__(self, parent):
        self.parent = parent
        self.export_dir = None
        self.include_memory_dump = self.parent.include_memory_dump
        self.include_highlighting = self.parent.include_highlighting
...
class PrepareExport:
    def __init__(self, parent):
        self.parent = parent
        self.file_handler = self.parent.file_handler
        self.command_details = self.parent.logic.commands_used
        ...
        if selected_file:
            export_data = {
                ...
                "commands": [
                    ...
                    for cmd in self.command_details
                ]
            }
            return export_data
        else:
